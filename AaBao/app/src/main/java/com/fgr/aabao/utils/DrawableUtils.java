...
public class DrawableUtils {// 有问题的类，25，26行
...
//        drawable.setGradientType(GradientDrawable.RECTANGLE); // 设置矩形0
        drawable.setGradientType(GradientDrawable.LINEAR_GRADIENT); // 设置矩形0
